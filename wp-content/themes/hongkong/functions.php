...
// Thumbnail sizes
add_image_size( 'wpbs-featured', 1024, 768, true );
add_image_size( 'wpbs-featured-home', 640, 350, true);
...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        wp_register_style('main', get_stylesheet_directory_uri() . '/library/css/main.css', array(), '1.0', 'all');
